...
const surveyQuestions = [
    { id: "u1", text: "Persyaratan pelayanan mudah dipenuhi." },
    { id: "u2", text: "Prosedur pelayanan mudah dan tidak berbelit-belit." },
    { id: "u3", text: "Waktu pelayanan sesuai dengan yang ditetapkan." },
    { id: "u4", text: "Biaya/tarif pelayanan terjangkau." },
    { id: "u5", text: "Produk/hasil pelayanan sesuai dengan yang diharapkan." },
    { id: "u6", text: "Petugas kompeten dan mampu memberikan pelayanan terbaik." },
    { id: "u7", text: "Petugas bersikap sopan dan ramah." },
    { id: "u8", text: "Sarana dan prasarana pelayanan memadai." },
    { id: "u9", text: "Penanganan pengaduan, saran, dan masukan ditanggapi dengan baik." },
];
...
export function FormSkm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    setIsLoading(true);
    try {
      const response = await fetch('/api/survei/skm', {
        method: 'POST',
        headers: {
                    ...
                    <FormControl>
                      ...
                      >
                        <FormItem className="flex items-center space-x-2">
                          ...
                          <FormLabel className="font-normal">Tidak Baik</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-2">
                          <FormControl>
                            <RadioGroupItem value="2" />
                          </FormControl>
                          <FormLabel className="font-normal">Kurang Baik</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-2">
                          <FormControl>
                         ...
                         <FormItem className="flex items-center space-x-2">
                          ...
                          <FormLabel className="font-normal">Sangat Baik</FormLabel>
                        </FormItem>
                      </RadioGroup>
                    </FormControl>
                    <FormMessage />
